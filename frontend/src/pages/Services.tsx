...
const processSteps = [
  {
    ...
    desc: "We assess your operational needs, regulatory requirements, and timeline to define the ideal candidate profile.",
  },
  {
    icon: Users,
    title: "Candidate Selection",
    desc: "Our recruiters match pre-vetted, certified professionals from our global talent pool to your specific requirements.",
  },
  {
    icon: Wrench,
    title: "Compliance & Onboarding",
    desc: "We handle all documentation, certifications, and compliance checks to ensure seamless integration.",
  },
  {
    icon: Clock,
    title: "Deployment & Support",
    desc: "Rapid mobilization with ongoing support throughout the contract duration, ensuring operational continuity.",
  },
];
      ...
      <section className="bg-[#222c4a] py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-white/70 text-lg max-w-3xl mx-auto leading-relaxed">
            Three dedicated divisions delivering sector-specific expertise
            across aviation, maritime, and offshore energy industries.
          </p>
        </div>
      </section>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <div className={index % 2 !== 0 ? "lg:order-2" : ""}>
                ...
                <h4 className="font-bold text-[#222c4a] mb-4">
                  Key Roles We Supply
                </h4>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-white/60 max-w-2xl mx-auto text-lg">
              A streamlined approach to delivering the right professionals for
              your operations.
            </p>
          </div>
      ...
      <section className="py-20 bg-[#f2eee7]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-[#5a6275] text-lg mb-8 max-w-2xl mx-auto">
            Whether you need workforce solutions or you're looking for your next
            contract opportunity, we're here to help.
          </p>
