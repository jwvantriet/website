...
function HeroSlider() {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden">
      ...
      {/* Static content – headline & CTA remain the same across all slides */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        <div className="max-w-2xl">
          ...
          <p className="text-white/70 text-lg md:text-xl leading-relaxed mb-8">
            Certified professionals ensuring compliance and operational
            continuity across safety-critical industries.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[#5a6275] max-w-2xl mx-auto text-lg">
              Confair operates in safety-critical industries where compliance,
              precision, and operational continuity are essential. Each vertical
              is supported by highly skilled professionals with sector-specific
              expertise.
            </p>
          </div>
            ...
            {verticals.map((v) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-[#222c4a] mb-3">
                    {v.title}
                  </h3>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[#5a6275] text-lg leading-relaxed mb-8">
                We deliver compliant, reliable workforce solutions to ensure
                operational continuity across aviation, maritime, and offshore
                environments.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-[#222c4a] rounded-2xl p-10 text-white">
              ...
              <p className="text-white/60 leading-relaxed mb-6">
                From single specialists to full project teams, we deliver
                certified professionals that ensure compliance, safety, and
            ...
            <div className="bg-[#f2eee7] rounded-2xl p-10">
              ...
              <p className="text-[#5a6275] leading-relaxed mb-6">
                Join our global network and access contract opportunities across
                aviation, maritime, and offshore energy in safety-critical
                environments.
              </p>
              <Link
                to="/contact"
