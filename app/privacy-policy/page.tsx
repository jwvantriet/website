...
export default function PrivacyPolicyPage() {
  return (
    <LegalPageLayout
      title="Privacy Policy"
      subtitle="How the Confair group collects, uses, and protects your personal data across aviation, maritime, and offshore operations."
    >
      <p>This is the Privacy Policy of the Confair group of companies (together, &quot;Confair&quot;):</p>
          ...
          <ul>
            ...
            <li><strong>Qualifications and Certifications:</strong> the licences, ratings, certificates and medical or safety documentation relevant to the User&apos;s profession and function group — for example, flight crew licences and aviation medical certificates and logbooks; cabin crew attestations; aircraft maintenance engineer licences (e.g. EASA Part-66) and type ratings; maritime certificates of competency and STCW certification; and offshore safety and survival certifications (e.g. BOSIET, GWO)</li>
          ...
          <p>Because the Confair group operates internationally (including in the Netherlands, the United Arab Emirates, and Germany), Personal Data may be transferred to and processed in countries outside the User&apos;s home country. Where Personal Data is transferred outside the European Economic Area, Confair will ensure an appropriate level of protection in accordance with applicable data protection law.</p>
          <p>The purpose of disclosure of Personal Data to clients of Confair is to perform the agreements concluded with clients pursuant to which Confair undertook to supply professionals (on the basis of secondment).</p>

          <h2>Alteration/Erasure of Personal Data</h2>
          <p>Users will have the right of access to and of rectification or erasure of their Personal Data, in accordance with the provisions laid down in the General Data Protection Regulation (&quot;GDPR&quot;) and other applicable data protection law.</p>
