...
async def callback(
    ...
    try:
        ...
        try:
            ...
            # No client secret configured — public client
            logger.debug("[callback] No client_secret configured, using public client flow")
        ...
        logger.info("[callback] Token exchange URL: %s", token_url)
