...
class GenTxtRequest(BaseModel):
    ...
    model: str = Field(
        ...
        description="Model name: gpt-5-chat / gemini-2.5-pro / gemini-3.1-pro-preview / claude-4-5-sonnet / deepseek-v3.2.",
    )
...
class GenVideoRequest(BaseModel):
    ...
    seconds: str = Field(default="8", description="Duration in seconds. Do NOT change unless specifically required.")
